...
export const Home: FC = () => {
    ...
    const linkToUni: string = path.split('/').at(1) === 'en' ? 'https://pwr.edu.pl/en/' : 'https://pwr.edu.pl/pl/';

    return (
        <AnimatePresence mode="wait">
            <section className='flex lg:flex-row lg:text-left text-center lg:py-10 py-20' id={t('id')}>
                <div className='lg:flex-1 mb-8 md:mb-0'>
                    ...
                    <motion.div className="py-10 text-center" initial={{ opacity: 0, y: -20 }}
                        animate={{ opacity: 1, y: 0 }}
                        exit={{ opacity: 0, y: -20 }}
